...
const specs: Spec[] = [
  ...
  { id: "sofa-fjord", name: "Fjord Sofa", category: "sofa", dims: [260, 100, 94], price: 1290, colors: ["plaster", "dusty-blue", "charcoal"], styles: ["scandinavian", "coastal"], seats: 4 },
  ...
  { id: "sofa-maren", name: "Maren Sofa", category: "sofa", dims: [240, 98, 104], price: 1090, colors: ["terracotta", "plum", "charcoal"], styles: ["mid-century"], seats: 3 },
  ...
  { id: "armchair-elsa", name: "Elsa Armchair", category: "armchair", dims: [72, 77, 88], price: 320, colors: ["dusty-blue", "plaster"], styles: ["coastal", "modern"], seats: 1 },
  { id: "armchair-kyst", name: "Kyst Armchair", category: "armchair", dims: [84, 86, 57], price: 460, colors: ["ochre", "charcoal", "oak"], styles: ["mid-century"], seats: 1 },
  { id: "armchair-ro", name: "Ro Armchair", category: "armchair", dims: [76, 80, 93], price: 350, colors: ["plum", "sage", "plaster"], styles: ["japandi"], seats: 1 },
  { id: "armchair-tuva", name: "Tuva Armchair", category: "armchair", dims: [80, 92, 111], price: 420, colors: ["terracotta", "oak", "charcoal"], styles: ["rustic", "scandinavian"], seats: 1 },

  { id: "bed-birk", name: "Birk Bed", category: "bed", dims: [160, 200, 63], price: 990, colors: ["oak", "sage", "plaster"], styles: ["scandinavian", "japandi"] },
  { id: "bed-ask", name: "Ask Bed", category: "bed", dims: [140, 200, 77], price: 690, colors: ["plaster", "dusty-blue"], styles: ["coastal", "scandinavian"] },
  { id: "bed-viggo", name: "Viggo Bed", category: "bed", dims: [180, 200, 71], price: 1490, colors: ["charcoal", "plum", "oak"], styles: ["modern", "mid-century"] },
  { id: "bed-lyng", name: "Lyng Bed", category: "bed", dims: [160, 200, 95], price: 890, colors: ["sage", "oak", "ochre"], styles: ["rustic", "japandi"] },
  { id: "bed-siv", name: "Siv Bed", category: "bed", dims: [180, 200, 58], price: 1190, colors: ["terracotta", "plaster", "charcoal"], styles: ["scandinavian", "modern"] },
  ...
  { id: "table-bord", name: "Bord Side Table", category: "table", dims: [45, 45, 40], price: 120, colors: ["oak", "plaster", "charcoal"], styles: ["scandinavian", "japandi", "modern"] },
  ...
  { id: "desk-soren", name: "Soren Desk", category: "desk", dims: [120, 60, 70], price: 390, colors: ["plaster", "oak"], styles: ["modern"] },
  ...
  { id: "shelf-lund", name: "Lund Shelf", category: "shelf", dims: [80, 30, 146], price: 290, colors: ["plaster", "oak"], styles: ["japandi"] },
  ...
  { id: "rug-flette", name: "Flette Rug", category: "rug", dims: [160, 253, 2], price: 240, colors: ["oak", "plaster", "dusty-blue"], styles: ["coastal"] },
  { id: "rug-mark", name: "Mark Rug", category: "rug", dims: [240, 340, 4], price: 590, colors: ["charcoal", "terracotta", "ochre"], styles: ["modern", "mid-century"] },
  { id: "rug-siv", name: "Siv Rug", category: "rug", dims: [200, 300, 3], price: 420, colors: ["plum", "sage", "plaster"], styles: ["japandi"] },
  ...
  { id: "table-lamp-alva", name: "Alva Table Lamp", category: "table-lamp", dims: [22, 22, 47], price: 120, colors: ["ochre", "plaster", "oak"], styles: ["scandinavian"] },
  { id: "table-lamp-natt", name: "Natt Table Lamp", category: "table-lamp", dims: [20, 20, 48], price: 90, colors: ["charcoal", "plum"], styles: ["modern"] },
  { id: "table-lamp-lune", name: "Lune Table Lamp", category: "table-lamp", dims: [24, 24, 52], price: 150, colors: ["plaster", "dusty-blue", "ochre"], styles: ["coastal"] },
  { id: "table-lamp-ember", name: "Ember Table Lamp", category: "table-lamp", dims: [21, 21, 43], price: 130, colors: ["terracotta", "oak"], styles: ["rustic", "mid-century"] },
  { id: "table-lamp-moss", name: "Moss Table Lamp", category: "table-lamp", dims: [23, 23, 24], price: 140, colors: ["sage", "plaster", "charcoal"], styles: ["japandi"] },
