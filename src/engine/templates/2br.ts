...
function goldenFurniture(): Furniture[] {
  return [
    ...
    item({ id: "floor-lamp-1", catalogId: "lamp-glow", roomId: "living", pos: { x: 440, y: 120 }, rotation: 0, colorway: "ochre" }),
    ...
    item({ id: "table-1", catalogId: "table-ake", roomId: "kitchen", pos: { x: 210, y: 240 }, rotation: 0, colorway: "oak" }),
    item({ id: "chair-1", catalogId: "chair-finn", roomId: "kitchen", pos: { x: 210, y: 165 }, rotation: 0, colorway: "sage" }),
    item({ id: "chair-2", catalogId: "chair-finn", roomId: "kitchen", pos: { x: 210, y: 315 }, rotation: 180, colorway: "sage" }),
    item({ id: "chair-3", catalogId: "chair-ida", roomId: "kitchen", pos: { x: 124, y: 240 }, rotation: 90, colorway: "dusty-blue" }),
    item({ id: "chair-4", catalogId: "chair-ida", roomId: "kitchen", pos: { x: 296, y: 240 }, rotation: 270, colorway: "dusty-blue" }),
    ...
    item({ id: "table-lamp-1", catalogId: "table-lamp-alva", roomId: "bed-1", pos: { x: 215, y: 80 }, rotation: 0, colorway: "ochre" }),
    item({ id: "table-lamp-2", catalogId: "table-lamp-alva", roomId: "bed-1", pos: { x: 215, y: 280 }, rotation: 0, colorway: "ochre" }),
    item({ id: "wardrobe-1", catalogId: "wardrobe-hald", roomId: "bed-1", pos: { x: 320, y: 30 }, rotation: 0, colorway: "oak" }),
    item({ id: "plant-3", catalogId: "plant-pilea", roomId: "bed-1", pos: { x: 270, y: 170 }, rotation: 0, colorway: "sage" }),

    item({ id: "bed-2", catalogId: "bed-ask", roomId: "bed-2", pos: { x: 100, y: 160 }, rotation: 270, colorway: "dusty-blue" }),
    item({ id: "desk-1", catalogId: "desk-soren", roomId: "bed-2", pos: { x: 310, y: 80 }, rotation: 90, colorway: "oak" }),
    item({ id: "chair-5", catalogId: "chair-mysa", roomId: "bed-2", pos: { x: 250, y: 80 }, rotation: 90, colorway: "sage" }),
    item({ id: "shelf-2", catalogId: "shelf-lund", roomId: "bed-2", pos: { x: 260, y: 305 }, rotation: 180, colorway: "plaster" }),

    item({ id: "plant-4", catalogId: "plant-ivy", roomId: "hall", pos: { x: 60, y: 175 }, rotation: 0, colorway: "sage" }),
  ];
}

/** Creates the canonical deterministic 2BR, including the 23-item onboarding scene when furnished. */
export function createTwoBedroomTemplate(furnished = false): Scene {
  ...
  const openings = [
    ...
    opening({ id: "window-second-east", roomId: "bed-2", wallId: "w1", offset: 20, width: 120, kind: "window", sillHeight: 90 }),
